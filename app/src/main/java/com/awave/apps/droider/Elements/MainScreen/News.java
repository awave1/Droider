...
public class News extends Fragment implements OnTaskCompleted, SwipeRefreshLayout.OnRefreshListener {

    private static final String FEED = "http://droider.ru/category/news/page/";
