...
public class Apps extends Fragment implements OnTaskCompleted, SwipeRefreshLayout.OnRefreshListener {
    private static final String FEED = "http://droider.ru/category/apps_and_games/programs/page/";
