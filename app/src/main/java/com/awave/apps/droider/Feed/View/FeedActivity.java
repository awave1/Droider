...
import com.awave.apps.droider.Main.NotifyService;
import com.awave.apps.droider.MainScreen.AboutFragment;
import com.awave.apps.droider.MainScreen.Preferences;
import com.awave.apps.droider.R;
import com.awave.apps.droider.Utils.Utils;
import com.awave.apps.droider.databinding.ActivityFeedBinding;

public class FeedActivity extends DroiderBaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void fragmentSetting() {
        ...
        if (!Utils.isOnline(this))
            ...
            getFragmentManager()
                    .beginTransaction()
                    .replace(R.id.container_main, FeedFragment.instance(Utils.HOME_URL))
                    .commit();
    }
